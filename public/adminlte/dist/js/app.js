...
function _init() {
  ...
  $.AdminLTE.layout = {
    ...
    pjaxMenuNav: function(){

   $('.sidebar-menu .menu-open').removeClass('menu-open').css('display','none');
   $('.sidebar-menu .active').removeClass('active');
   var domain_name_ = location.protocol+'//'+window.location.host;
   $(".sidebar-menu a").each(function () {
        if (($(this).attr('href')) && (domain_name_+location.pathname+location.search === $(this).attr('href'))) {
   ...
   toggleSideBar: function(){
    ...
    console.log(o.navbarMenuSlimscrollWidth);
