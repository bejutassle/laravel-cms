       ...
       <div class="panel-body">
            @if(null == Session::get('ok'))
               ...
               <div class="bs-component" style="text-align: center;padding:80px;">
                <a href="http://fire2000.rocks" class="btn btn-info  btn-lg popup-action">GET  Buzzy Code</a>
            </div>
                    ...
                    <form method="post" action="{{ route('installer::checkedcode') }}">
                        <div class="row">
                            <div class="form-group col-md-12">
                                ...
                                <div class="col-md-10">
                                    <input class="input-lg form-control" style="height: 46px;padding: 10px 16px; font-size: 18px; line-height: 1.3333333; border-radius: 6px;" name="code" type="text" value="Nulled-by-fire2000" disabled="disabled">
                                </div>
                                    <div class="col-md-2">
