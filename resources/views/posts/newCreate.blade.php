@extends("app")
@section('head_title', trans('addpost.create', ['type' => ucfirst($category->posturl_slug) ]).' | '.getcong('sitename'))
                    ...
                    <fieldset>
                        ...
                        @if($typene=='quiz')
                            <section class="form last" id="addnew"  style="border-bottom: 1px solid #e3e3e3;">
                                ...
                                <legend>{!! trans('quiz.quizresults') !!}</legend><br>
                        ...
                        <section class="form" >
                            ...
                            @if($typene=='quiz')
                                <a class="submit-button button button-black button-full postable"  style="width:100%;float:none;padding-left:0;padding-right:0;" data-method="Get" data-target="entries" data-puttype="append" data-type="questionform" href="{{ action('FormController@addnewform') }}?addnew=question"><i class="fa fa-question-circle"></i>{!! trans('addpost.add', ['type' => trans('quiz.question')]) !!}</a>
