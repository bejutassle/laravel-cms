<div class="sidebar">
    <div class="question-post-side-bar-form">
        ...
        @if((isset($post->approve) && $post->approve == 'draft'))
            {!! Form::submit(trans('addpost.createp'), ['class' => 'button button-black button-full submit-button PostAction', 'data-post-t' => 'post']) !!}
        @else
                    {!! Form::submit(isset($post->id) ? trans('addpost.savec') : trans('addpost.createp'), ['class' => 'button button-black button-full submit-button PostAction', 'data-post-t' => 'post']) !!}
        @endif

            {!! Form::submit(trans('updates.saveasdraft'), ['class' => 'button button-gray button-full submit-button PostAction', 'data-post-t' => 'draft']) !!}
            @if(isset($post->id))
