<div class="box box-primary box-solid direct-chat direct-chat-primary collapsed-box">
    <div class="box-header">
        ...
        <div class="box-tools pull-right">
            <a href="widgets?edit={{ $widget->id }}" data-toggle="tooltip" title="{!! trans('admin.Edit') !!}" class="btn btn-box-tool btn-info"><i class="fa fa-edit"></i></a>
            <a href="{{ url('admin/widgets/delete/'.$widget->id) }}" data-toggle="tooltip" title="{!! trans('admin.delete') !!}" class="btn btn-box-tool btn-danger permanently"><i class="fa fa-times"></i></a>
