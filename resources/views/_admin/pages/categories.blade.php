        ...
        <div class="col-md-8">
            ...
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs pull-right">
                    ...
                    <li class="pull-left header"><i class="fa fa-{{ $categorys->icon }}"></i> <b>{{ $categorys->name }}</b> @if($categorys->disabled==1) <span class="pull-right badge bg-red" data-toggle="tooltip" title="{!! trans('admin.DeactivatedonPlugins') !!}" STYLE="margin-top:7px;margin-left:10px">{!! trans('admin.DISABLED') !!}</span>  @endif
                        ...
                        <div class="tab-pane @if(isset($category->id)) @if($category->main==1 or $category->main==2) active @endif @else active @endif" id="fa-icons">
                            ...
                            <div class="box-body" style="padding:20px">
                                ...
                                <div class="form-group">
                                    ...
                                    {!! Form::text('order',  isset($category->order) ? $category->order : null, ['id' => 'order', 'class' => 'form-control input-lg', 'placeholder' => trans('admin.Entercategoryorder') ]) !!}
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    {!! Form::text('icon',  isset($category->icon) ? $category->icon : null, ['id' => 'icon', 'class' => 'form-control input-lg', 'placeholder' => trans('admin.Icon')]) !!}
                                </div>
                                <div class="form-group">
                                ...
                                @if( (isset($category->id)) && ($category->main==2) )
                                <div class="form-group">
