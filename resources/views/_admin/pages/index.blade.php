...
@section('title', trans('admin.adminpanel'))
@section("content")
...
<div class="row">
    <div class="col-lg-3 col-xs-6">
        ...
        <div class="small-box bg-green">
            ...
            <a href="{{action('Admin\PostsController@unapprove', ['only=unapprove'])}}" class="small-box-footer">{!! trans('admin.moreinfo') !!} <i class="fa fa-arrow-circle-right"></i></a>
        </div>
    </div><!-- ./col -->
    <div class="col-lg-3 col-xs-6">
        <!-- small box -->
        <div class="small-box bg-aqua">
            ...
            <a href="{{action('Admin\PostsController@all')}}" class="small-box-footer">{!! trans('admin.moreinfo') !!} <i class="fa fa-arrow-circle-right"></i></a>
        </div>
    </div><!-- ./col -->
    <div class="col-lg-3 col-xs-6">
        <!-- small box -->
        <div class="small-box bg-yellow">
            ...
            <a href="{{action('Admin\UsersController@users', ['order' => 'lastregister'])}}" class="small-box-footer">{!! trans('admin.moreinfo') !!} <i class="fa fa-arrow-circle-right"></i></a>
        </div>
    </div><!-- ./col -->
    <div class="col-lg-3 col-xs-6">
        <!-- small box -->
        <div class="small-box bg-red">
            ...
            <a href="{{action('Admin\UsersController@users', ['order' => 'lastlogin'])}}" class="small-box-footer">{!! trans('admin.moreinfo') !!} <i class="fa fa-arrow-circle-right"></i></a>
        </div>
    </div><!-- ./col -->
</div><!-- /.row -->
<!-- Main row -->
        ...
        <div class="col-md-6">
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    @if(\App\Posts::approve('yes')->byType($cat->type)->latest('published_at')->take('5')->get()->isEmpty())
                        {!! trans('admin.nothingtoseehere') !!}
                    @endif
                </div><!-- /.box-body -->
                <div class="box-footer text-center">
                    <a href="{{action('Admin\PostsController@showcatposts', ['cat' => 'news'])}}" class="uppercase">{!! trans('admin.viewall') !!}</a>
                </div><!-- /.box-footer -->
            </div>
        </div>
        @endforeach
            ...
            <div class="box box-default">
                <div class="box-header with-border">
                    ...
                    <div class="box-tools pull-right">
                        <span class="label label-danger">{!! trans('admin.newmemberstoday', ['users' => $todayusers ]) !!}</span>
                        <button class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
                        <button class="btn btn-box-tool" data-widget="remove"><i class="fa fa-times"></i></button>
                    </div>
                </div><!-- /.box-header -->
                    ...
                    <ul class="users-list clearfix">
                        @foreach($lastusers as $user)
                            <li style=" width: 20%;">
                                ...
                                <a class="users-list-name" target="_blank" href="{{action('UsersController@index', [$user->username_slug])}}">{{ $user->username }}</a>
                ...
                <div class="box-footer text-center">
                    <a href="{{action('Admin\UsersController@users')}}" class="uppercase">{!! trans('admin.viewall') !!}</a>
                </div><!-- /.box-footer -->
            </div><!--/.box -->
    </section><!-- /.Left col -->
                        ...
                        @foreach($lastunappruves as $item)
                            <tr>
                                ...
                                <td style="text-align: center;">
                                            ...
                                            <li class="divider"></li>
                                            <li><a target=_blank href="{{action('PostsController@CreateEdit', $item->id)}}">{!! trans('admin.editpost') !!}</a></li>
                                            <li class="divider"></li>
