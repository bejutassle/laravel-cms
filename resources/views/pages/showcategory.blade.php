...
@section('head_title',  getcong('sitename').' | '.$category->name)
...
<a style="font-size:16px;margin-left:10px;color:#999;" data-type="{{ $cat->name_slug }}" href="{{ action('PagesController@showChildCategory', ['parent' => $category->name_slug, 'catname' => $cat->name_slug]) }}"> {{ $cat->name }}</a>
            ...
            <div class="mainside cat">
                ...
                <div class="colheader none">
                    ...
                    @elseif(isset($category->name))
                        <h1>{!! trans('index.latestcat', ['type' => $category->name ]) !!}</h1>
                    @endif
            ...
            <div class="sidebar">
                ...
                @endforeach
                    ...
                    <div class="colheader" style="border:0;text-transform: uppercase">
                        <h1>{!! trans('index.weekly') !!} {!! trans('index.top', ['type' => '<span>'.$category->names.'</span>' ]) !!}</h1>
                    </div>
