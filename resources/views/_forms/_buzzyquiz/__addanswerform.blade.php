...
<div  class="answer-wrapper">
    ...
    </div>{!! Form::hidden(null, isset($entry->image) ? makepreview($entry->image, null, 'answers') : null, ['data-type' => 'image', 'class' => 'cd-input-image ']) !!}
    ...
    <div class="inpunting " style=" padding:0">
        {!! Form::textarea(null, isset($entry->title) ? $entry->title : null ?: null, ['data-type' => 'title', 'class' => 'cd-input answerinput', 'placeholder' => trans('quiz.entry_answertitle')]) !!}
    </div>
    <div class="inpunting " style="background:#ccc; padding:0">
        <?php $idoa=time(); ?>
        {!! Form::select(null, ['' => trans('quiz.assign')] , null, [ 'class' => 'getassignres', 'data-identy' => $idoa, 'data-acst' =>  isset($entry->video) ? (int)$entry->video : null, 'data-type' => 'assign' ]) !!}
    </div>
</div>
</div>
